                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 ">
                            <input type="text" class="form-control date-picker" id="tgl_peramalan" name="tgl_peramalan"
                                placeholder="Masukkan tanggal yang hendak diramalkan " autocomplete="off" required>
                        </div>

                    </div>

                    <div class="row float-left" style="display:none ;" id="buttonHitungPeramalanSemuaProduk">
                        <!-- <button type="submit" class="btn ml-2 mr-3 btn-info hitungPeramalanSemua">Hitung
                            Peramalan Semua Produk
                        </button> -->
                    ...
                    <div class="row float-right" style="display:none ;" id="buttonAksi">
                        <!-- <button type="submit" class="btn ml-2 mr-3 btn-primary hitungPeramalan">Hitung
                            Peramalan</button> -->
                        <a href="#" class=" btn ml-2 mr-3 btn-primary
                            hitungPeramalan">Hitung Peramalan</a>
...
$(document).ready(function() {
    ...
    $('.hitungPeramalan').click(function() {
        ...
        $.ajax({
            ...
            method: "post",
            success: function(data) {
                window.location.href = "hasilPeramalan";
            },
        });
