        ...
        <div class="col-lg">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row"><label for="" class="col-sm-6 col-form-label">Nomor Stok Masuk</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group row"><label for="" class="col-sm-6 col-form-label">Status Pembelian</label>
                                <div class="col-sm-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row"><label for="" class="col-sm-6 col-form-label">Nama Supplier</label>
                                <div class="col-sm-6">
                                    <div type="text" readonly="readonly" id="" class="form-control-plaintext">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group"><label for=""><b>Catatan Pembelian</b></label>
                                <textarea name="" id="" rows="3" readonly="readonly" disabled="disabled" class="form-control bg-white"><?= $stok_masuk->catatan_pembelian; ?>
                                </textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="hutangForm">
                        ...
                        <div class="col-md-3 pt-auto"><button data-toggle="modal" data-target="#tambahPembayaran" class="btn btn-primary rounded-0 shadow-none">
                                Tambah Pembayaran
                            </button></div>
                    </div>
