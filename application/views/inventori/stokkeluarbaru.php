                    ...
                    <form method="post" action="">
                        ...
                        <div class="col-md-12 col-xs-12 col-lg-12 ">
                            ...
                            <div class="row border-bottom p-2 align-items-center" id="form_produk_masuk1">
                                <div class="col-5 pl-0 ">
                                    <select id="select_produk" name="select_produk[]" class="select_produk form-control"
                                        required>
                                        <option value="">Pilih Produk</option>
                                        <?php foreach ($produk as $pro) : ?>
                                        <option value="<?= $pro['id']; ?>"><?= $pro['nama'] . ' || ' ?>
                                            <strong><?= 'Stok ' . $pro['jumlah'] ?></strong>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="col-3">
                                    <select id="select_alasan" name="select_alasan[]" class="select_alasan form-control"
                                        required>
