                    ...
                    <form method="post" action="">
                        <div class="row">
                            <div class="col-md-5 col-sm-5">
                                ...
                                <input type="hidden" name="no_pembelian" id="no_pembelian" value="<?= $stok_masuk->no_pembelian; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="supplier" id="select_supplier" class="form-control">
                                        ...
                                        <?php foreach ($supplier as $s) : ?>
                                            <option value="<?= $s['id']; ?>" <?php if ($s['id'] == $stok_masuk->idSupplier) : ?>selected <?php endif; ?>>
                                                <?= $s['nama']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control date" id="edit_tgl_pembelian" name="edit_tgl_pembelian" autocomplete="off" value="<?= $stok_masuk->tanggal_pembelian; ?>">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="catatan_pembelian" id="catatan_pembelian" rows="3"><?= $stok_masuk->catatan_pembelian; ?></textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="col-5 pl-0 ">
                                        <select name="select_produk[]" class="select_produk form-control" required>
                                            ...
                                            <?php foreach ($produk as $p) : ?>
                                                <option value="<?= $p['id']; ?>" <?php if ($p['id'] == $smp->id_produk) : ?>selected <?php endif; ?>>
                                                    <?= $p['nama']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-2">
                                        <input type="number" class="jumlah_produk form-control" id="jumlah_produk<?= $co; ?>" name="jumlah_produk[]" autocomplete="off" id-input="<?= $co; ?>" value="<?= $smp->jumlah_produk; ?>" required>
                                    </div>
                                    <div class="col-2">
                                        <input type="number" class="harga_produk form-control" id="harga_produk1<?= $co; ?>" name="harga_produk[]" autocomplete="off" id-input="<?= $co; ?>" value="<?= $smp->harga_produk; ?>" required>
                                    </div>
                                    <div class="col-2">
                                        <input type="number" class="total_produk form-control" id="total_produk<?= $co; ?>" name="total_produk[]" autocomplete="off" id-input="<?= $co; ?>" value="<?= $smp->total_produk; ?>" required>
                                    </div>
                                    <?php if ($co > 1) : ?>
                                        <div class="col-1">
                                            <button type="button" onclick="deleteSlot(<?= $co; ?>)" class="btn btn-outline-danger">Hapus</button>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php $co++;
