    ...
    <div class="container-fluid">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 ">
                                <input type="text" class="form-control date" id="kasir" name="kasir"
        ...
        <div class="row mt-3">
            <div class="col-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row"><label for="biaya_servis" class="col-sm-4 col-form-label">Biaya
                                Service</label>
                            <div class="col-sm-8"><input type="number" id="biaya_servis" name="biaya_servis"
                                    class="form-control shadow-none" value=0></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row"><label for="subtotal" class="col-sm-4 col-form-label">Sub
                                total</label>
                            <div class="col-sm-8">
                                <div disabled="disabled" id="subtotal" readonly="readonly"
                        ...
                        <div class="form-group row"><label for="diskon" class="col-sm-4 col-form-label">Discount</label>
                            <div class="col-sm-8"><input type="number" name="diskon" id="diskon"
                                    class="form-control shadow-none" value=0></div>
                        </div>
                        <div class="form-group row"><label for="hargatotal" class="col-sm-4 col-form-label">Harga
                                Total</label>
                            <div class="col-sm-8">
                                <div disabled="disabled" readonly="readonly" id="hargatotal"
                                    class="form-control shadow-none">
                                    Rp 0,00
                                </div>
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row"><label for="keterangan"
                                class="col-sm-4 col-form-label">Keterangan</label>
                            <div class="col-sm-8"><input type="text" name="keterangan" class="form-control shadow-none"
                                    value="-"></div>
                        </div>
                        <div class="row">
                            <div class="col-6"><button type="submit" class="btn btn-block btn-primary btn-flat"
                                    type="submit">
                                    Simpan
                                </button></div>
                            <div class="col-6"><a href="<?= base_url('penjualan/kasir') ?>"
